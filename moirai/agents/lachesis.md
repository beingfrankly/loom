...
Before writing any moirai artifact, you MUST invoke the corresponding skill:
...
<step order="1">Check if .moirai/sessions/ directory exists and has active sessions</step>
...
<session-path>.moirai/sessions/{ticket-id}/</session-path>
</session-structure>

### Session Artifacts

All artifacts live in `.moirai/sessions/{ticket-id}/`:
...
<step order="2">Create the session directory: .moirai/sessions/{ticket-id}/</step>
...
.moirai/sessions/ii-5092/context.md
...
<step order="2">Create session directory: .moirai/sessions/{TOPIC-SLUG}/ (e.g., "hook-enhancement")</step>
